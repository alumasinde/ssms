...
$router->post('/grade-scales/store',       [\Exams\GradeScalesController::class, 'store']);
$router->post('/grade-scales/clear',       [\Exams\GradeScalesController::class, 'clear']);
$router->post('/grade-scales/{id}/delete', [\Exams\GradeScalesController::class, 'delete']);
$router->post('/grade-scales/{id}/update', [\Exams\GradeScalesController::class, 'update']);
